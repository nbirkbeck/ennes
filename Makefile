...
SIMPLE_RENDER_OBJS = simple_renderer.o proto/render_state.pb.o render_utils.o sprite.o extract_colors.o screen.o
...
RENDER_OBJS = renderer.o proto/render_state.pb.o render_utils.o sprite.o extract_colors.o highres_boundary.o mesh_utils.o screen.o
